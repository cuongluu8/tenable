...
import rollOfHonour from "./routes/rollOfHonour";
import guess from "./routes/guess";
import media from "./routes/media";
import mediaAudit from "./routes/mediaAudit";
import multiplayer from "./routes/multiplayer";
import remoteSession from "./routes/remoteSession";
...
app.route("/api/roll-of-honour", rollOfHonour);
app.route("/api/guess", guess);
app.route("/api/media", media);
app.route("/api/multiplayer", multiplayer);
app.route("/api/remote", remoteSession);
