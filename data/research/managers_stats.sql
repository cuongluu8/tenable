-- entity_stats research output (career-titles-count, manager-status). Review before applying.
-- generated 2026-08-31

INSERT INTO entity_stats (entity_id, stat_key, scope, value_numeric, display_value, as_of_date, source, verified_at) VALUES
(19180, 'manager-status', 'career', NULL, 'retired', '2026-08-31', 'Wikipedia', '2026-08-31'),
(19181, 'career-titles-count', 'career', 21, '21', '2026-08-31', 'Liverpool FC', '2026-08-31'),
(19181, 'manager-status', 'career', NULL, 'retired', '2026-08-31', 'Wikipedia', '2026-08-31'),
(19183, 'manager-status', 'career', NULL, 'retired', '2026-08-31', 'Wikipedia', '2026-08-31'),
(19184, 'manager-status', 'career', NULL, 'retired', '2026-08-31', 'Wikipedia', '2026-08-31');

INSERT INTO entity_stats (entity_id, stat_key, scope, value_numeric, display_value, as_of_date, source, verified_at) VALUES
(19188, 'manager-status', 'career', NULL, 'active', '2026-08-31', 'Wikipedia', '2026-08-31'),
(19189, 'manager-status', 'career', NULL, 'active', '2026-08-31', 'ITV News', '2026-08-31'),
(19191, 'manager-status', 'career', NULL, 'active', '2026-08-31', 'ESPN', '2026-08-31');
